...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ResolvedShard) DeepCopyInto(out *ResolvedShard) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ResolvedShard.
func (in *ResolvedShard) DeepCopy() *ResolvedShard {
	if in == nil {
		return nil
	}
	out := new(ResolvedShard)
	in.DeepCopyInto(out)
	return out
}
